package com.la.xuecheng.generator;
...
public class ContentCodeGenerator {
	...
	//数据库密码
	private static final String DATA_SOURCE_PASSWORD  = "1257695265";
	//生成的表
...
//			"mq_message_history"
	...
	public static void main(String[] args) {
		...
		dsc.setUrl("jdbc:mysql://192.168.101.132:3306/xuecheng-content" +
